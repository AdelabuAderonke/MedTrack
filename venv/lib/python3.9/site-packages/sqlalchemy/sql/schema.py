    ...
    def __init__(
        ...
        **kw: Any,
        ...
        if self.schema is not None:
            self.name = "%s.%s" % (self.schema, self.name)
        else:
            self.name = self.name
        ...
        **kw: Any,
        ...
        if self.primary_key:
            ...
            raise exc.ArgumentError(
                ...
                f"non-primary-key column on table '{table.name}'"
            )
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    target_name = property(_get_colspec)
    ...
    def _validate_dest_table(self, table: Table) -> None:
        ...
        if None not in table_keys and len(table_keys) > 1:
            ...
            raise exc.ArgumentError(
                ...
                f"{table.name}({self._col_description}) refers to "
