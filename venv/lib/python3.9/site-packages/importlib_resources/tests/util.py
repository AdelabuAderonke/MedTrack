...
class MemorySetup(ModuleSetup):
    ...
    class MemoryLoader(importlib.abc.Loader):
        ...
        def get_resource_reader(self, name):
            return MemorySetup.MemoryTraversableResources(self._module, name)
    ...
    class MemoryTraversableResources(TraversableResources):
        ...
        def files(self):
            return MemorySetup.MemoryTraversable(self._module, self._name)
    ...
    class MemoryTraversable(Traversable):
        ...
        def _resolve(self):
            ...
            """
            path = pathlib.PurePosixPath(self._name)
        ...
        def iterdir(self):
            ...
            if not isinstance(directory, dict):
                ...
                raise OSError(f"{self._name} is not a directory")
            for path in directory:
                yield MemorySetup.MemoryTraversable(
                    self._module, f"{self._name}/{path}"
                )
        ...
        def open(self, mode='r', encoding=None, errors=None, *_, **__):
            ...
            if isinstance(contents, dict):
                ...
                raise OSError(f"{self._name} is a directory")
        ...
        @property
        def name(self):
            return pathlib.PurePosixPath(self._name).name
